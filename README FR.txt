FlanToDynamX développé par Pacito2#2813.
...
Vos modèles .java doivent être générés via Toolbox (Export > As Flans Model). 
N'oubliez pas d'exporter les textures (Export > As Texture File).

1. Edition des modèles .java
...
2. Passage des modèles .java en .obj
...
3. Ajout des véhicules sur DynamX
...
4. Credits
	...
	-	Pacito2		Développements des programmes.
